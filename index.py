...
class EmployeeSystem:
    def __init__(self,root):
        ...
        txt_Employee_code=Entry(Frame1,bg='lightyellow',textvariable=self.var_emp_code,font=("Times New Roman",15,"bold")).place(x=230,y=85,width=300)
        btn_search=Button(Frame1,text='Search',font=("Times New Roman",15,"bold"),bg='#656A57',padx=20).place(x=560,y=80)
        ...
        Calculate=Button(Frame2,text='Calculate',command=self.calculate,bg='lightblue',font=("Times New Roman",18,"bold"),).place(x=80,y=265)
        Save=Button(Frame2,text='Save',bg='lightgreen',command=self.add,font=("Times New Roman",18,"bold"),).place(x=280,y=265)
        Clear=Button(Frame2,text='Clear',bg='lightgrey',font=("Times New Roman",18,"bold"),).place(x=440,y=265)
...
'''
        ...
        btn_print=Button(salary_f,text='Print',font=("Times New Roman",18,"bold"),bg='lightgrey',fg='black').place(x=260,y=302,width=120,height=40)
